...
It creates correct database on your local MySQL server.
You should enter your database settings (username and password) at the beginning of the application code in the marked place.

The project is launched directly from Intellij IDEA.
